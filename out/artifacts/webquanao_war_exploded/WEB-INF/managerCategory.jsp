<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <body class="p-3">
        ...
        <button class="btn btn-primary mb-3" onclick="openAddModal()">+ Thêm danh mục</button>
        ...
        <div class="modal fade" id="confirmModal" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p id="confirmMessage">Bạn có chắc chắn muốn thay đổi trạng thái danh mục này?</p>
                        <input type="hidden" id="toggleCategoryId">
                    </div>

                    <div class="modal-footer">
                        <button class="btn btn-secondary" data-bs-dismiss="modal">Huỷ</button>
                        <button class="btn btn-danger" onclick="executeToggle()">Đồng ý</button>
                    </div>
        ...
        <script>
                    ...
                    columns: [
                        ...
                        { data: 'name' },
                        {
                            ...
                            render: function (data, type, row) {
                                return data ? '<span class="badge bg-success">Đang hoạt động</span>' : '<span class="badge bg-secondary">Đã tắt</span>';
                            }
                        },
                        {
                            data: null,
            ...
            function openToggleModal(id, isActive) {
                ...
                document.getElementById('confirmMessage').innerText = `Bạn có chắc chắn muốn \${action} danh mục này?`;
                confirmModal.show();
            }
