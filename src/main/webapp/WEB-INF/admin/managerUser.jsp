                ...
                <div class="row">
                    <div class="col-md-2 p-0 sidebar">
                        ...
                        <nav>
                            ...
                            <a href="<%= request.getContextPath() %>/admin/managerUser" class="active">Quản lý Người
                                dùng</a>
                            <hr>
                            ...
                            <tbody>
                                <c:forEach var="user" items="${users}">
                                    ...
                                    <c:forEach var="role" items="${user.roles}" varStatus="status">
                                        <c:set var="roleIdsText"
                                            value="${roleIdsText}${role.id}${status.last ? '' : ','}" />
                                    </c:forEach>
                                    <tr>
                                        <td>
                                            <c:out value="${user.id}" />
                        ...
                        <form action="${pageContext.request.contextPath}/admin/managerUser" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">Mật khẩu <span id="passwordRequired"
                                                class="text-danger">*</span></label>
                                        <input type="password" name="password" id="password" class="form-control">
                                        <small class="text-muted" id="passwordHint">Bắt buộc khi thêm mới. Khi sửa, để
                                            trống nếu không đổi mật khẩu.</small>
                                    </div>
                                    <div class="col-md-6">
