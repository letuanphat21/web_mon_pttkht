    ...
    <div class="row">
        <div class="col-md-2 p-0 sidebar">
            ...
            <nav>
                ...
                <a href="${pageContext.request.contextPath}/admin/statistics" class="active">Thống kê</a>
        ...
        <div class="col-md-10 p-4">
            ...
            <form class="row g-3 align-items-end mb-4" action="${pageContext.request.contextPath}/admin/statistics" method="get">
                <div class="col-md-3">
                    <label class="form-label">Loại thống kê</label>
                    <select class="form-select" name="type">
                        <option value="overview" ${type == 'overview' ? 'selected' : ''}>Tổng quan</option>
                        <option value="revenue" ${type == 'revenue' ? 'selected' : ''}>Doanh thu</option>
                        <option value="products" ${type == 'products' ? 'selected' : ''}>Sản phẩm bán chạy</option>
                        <option value="categories" ${type == 'categories' ? 'selected' : ''}>Theo danh mục</option>
                    </select>
                </div>
                <div class="col-md-2">
                    <label class="form-label">Từ ngày</label>
                    <input class="form-control" type="date" name="startDate" value="${startDate}" required>
                </div>
                <div class="col-md-2">
                ...
                <table class="table table-bordered table-hover mb-4">
                    ...
                    <c:forEach var="row" items="${dailyRevenue}">
                        <tr>
                            ...
                            <td><fmt:formatNumber value="${row.revenue}" pattern="#,###"/> VNĐ</td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
