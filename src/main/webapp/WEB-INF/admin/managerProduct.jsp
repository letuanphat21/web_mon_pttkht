          ...
          <div class="row">
            <div class="col-md-2 p-0 sidebar">
              ...
              <nav>
                ...
                <a href="<%= request.getContextPath() %>/admin/managerProduct" class="active">Quản lý Sản phẩm</a>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row g-3">
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="number" id="productPrice" class="form-control" min="1000"
                        ...
                        <div class="col-12">
                          ...
                          <textarea id="productDesc" class="form-control" rows="3"
