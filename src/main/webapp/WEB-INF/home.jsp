...
<div class="container" style="padding: 20px; max-width: 1200px; margin: 0 auto;">
    ...
    </div> </div> <div id="product-detail-modal" style="display:none; position:fixed; z-index:998; background:rgba(0,0,0,0.5); top:0; left:0; width:100%; height:100%;">
    <div style="background:white; width: 450px; padding:25px; position:absolute; top:50%; left:50%; transform:translate(-50%, -50%); border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.3); text-align: center;">
        ...
        <span onclick="closeProductModal()" style="position: absolute; right: 15px; top: 10px; font-size: 24px; cursor: pointer; color: #aaa;">&times;</span>

        <img id="modal-p-image" src="" style="width: 100%; height: 250px; object-fit: cover; border-radius: 6px;">
